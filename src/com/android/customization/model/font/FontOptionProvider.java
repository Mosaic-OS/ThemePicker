...
public class FontOptionProvider {
    ...
    private void loadOptions() {
        // Re-query installed font overlays every (re)load so packages installed or removed after
        // this process-lifetime provider was constructed are reflected in the picker.
        mOverlayPackages.clear();
        mOverlayPackages.addAll(mOverlayManager.getOverlayPackagesForCategory(OVERLAY_CATEGORY_FONT,
